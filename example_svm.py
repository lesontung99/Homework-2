...
from svmKernels import myCosineSimilarityKernel, myGaussianKernel, myPolynomialKernel


# load the data
filename = "Questions\CIS419-master\Assignment2\hw2_skeleton\data\svmData.dat"
